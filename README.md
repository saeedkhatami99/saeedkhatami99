...
## NowPlaying (spotify now playing in telegram, instagram, and any markdown )

## HTTP (http server in assembly)

## KReW (kernel read and write(bsod simulator))
...
CommitACrime 45
---------------------------------------------
Secret Projects Coded in the Dark: 1134425
```
<!-- LOC-END -->
